...
在 5/7 冷启动诊断基础上，进行了第二轮深度风格调整：

- **核心问题**：AI 腔太重，不像真人写的
- **解决方向**：用自己的真实口吻写公众号
- **方法**：深度分析「逛逛GitHub」的爆款套路，逐项对标改进

### 文章版本迭代

1. **V1**「我测了6款免费AI写文章工具」— 传统排版，段落过长
2. **V2** — 加入5张 HTML + Playwright 截图配图，开始走向证据型
3. **V3（目标）** — 一句一段 + 真人口吻 + 证据型截图 + 冲突标题

### 关键学习

- 公众号写作用真实语气，一句一段，GitHub截图作证据
- 逛逛GitHub本质就是推荐开源项目+贴截图，没有实测，但阅读体验极佳
- 详见 [[wechat-writing-style]]
